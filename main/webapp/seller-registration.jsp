				...
				<div class="row">
					<div class="12">
						<div class="contact-wrap">
							<form action="SellerController" class="contact-form"
									...
									<div class="col-md-6">
										<div class="form-group">
											<label for="fname">First Name</label> <input type="text"
												...
												name="fname" onblur="check_fname();" required="required" autocomplete="off"> 
									...
									<div class="col-md-6">
										<div class="form-group">
											<label for="lname">Last Name</label> <input type="text"
												...
												name="lname" onblur="check_lname();" required="required" autocomplete="off"> <span
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label for="email">Contact</label> <input type="tel"
												...
												name="contact" onblur="check_contact();" minlength="10" Maxlength="10"required="required" autocomplete="off"> <span
												id="errorcontact" style="color: red;"></span>
										</div>
									</div>
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label for="email">Email</label> <input type="text"
												...
												onblur="searchInfo()" required="required" autocomplete="off"> <span id="tops"
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label for="email">Address</label> <input type="text"
												...
												name="address" onblur="check_address();" required="required" autocomplete="off">
												 <span
												id="erroraddress" style="color: red;"></span>
										</div>
									</div>
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label for="email">Password</label> <input type="password"
												id="password" class="form-control" placeholder="Your Password"
												name="password" onblur="check_password();" required="required" autocomplete="off">
												 <span
